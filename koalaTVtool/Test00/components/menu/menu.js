...
Component({
  ...
  methods: {
    ...
    popp: function () {
      ...
      animationDelLots.translate(0, 100 / 750 * systemInfo.windowWidth).rotateZ(180).opacity(1).step();
      animationAdd.translate(0, 200 / 750 * systemInfo.windowWidth).rotateZ(180).opacity(1).step();
      this.setData({
